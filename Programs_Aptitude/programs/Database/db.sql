...
select count(*) from employees where Department_ID=60 and HIRE_DATE BETWEEN '1987-06-17' and '1987-07-28';

select Employee_ID,concat(FIRST_NAME,' ',LAST_NAME) as Employee_NAME,salary from employees where salary >=10000;

select * from employees where JOB_ID='IT_PROG' or JOB_ID='FI_ACCOUNT';

 select Employees.EMployee_ID,Employees.JOB_ID,JOB_TITLE from employees JOIN jobs on Employees.JOB_ID=JOBS.JOB_ID where Employees.JOB_ID='IT_PROG' or Employees.JOB_ID='FI_ACCOUNT';

select Employees.EMployee_ID,JOBS.JOB_ID,JOB_TITLE from employees , jobs where Employees.JOB_ID=JOBS.JOB_ID having JOBS.JOB_ID='IT_PROG' or JOBS.JOB_ID='FI_ACCOUNT';
